...
def Fail(jid, state):
	if state == 'fail':
		...
		doc = db1[user_id]
		if state:
			doc[jid] = {'overall_marks': overall_marks, 'cv_score': cv_score, 'apt_marks': apt_marks, 'tech_marks': tech_marks, 'experience': exp, 'interview_score': interview_score, 'interview_skills': interview, 'status': 'Applied'}
		else:
			doc[jid] = {'overall_marks': overall_marks, 'cv_score': cv_score, 'apt_marks': apt_marks, 'tech_marks': tech_marks, 'experience': exp, 'interview_score': interview_score, 'interview_skills': interview, 'status': 'Disqualified'}
